...
{{-- @if ($segment1 = 'supplier' && $segment1 != 'collection-point' && $segment1 != 'vendor-profile') --}}
{{--    <div class="col-12 mt-1"><h5>Bank Details</h5></div> --}}
{{-- @endif --}}
    ...
    <div class="mb-1">
        ...
        <select name="bank_id" class="form-control select2">
            ...
            @foreach ($banks as $bank)
                <option value="{{ $bank->id }}" {{ $bank->id == old('bank_id') ? 'selected' : '' }}>(
    ...
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 mb-1 pe-0">
            ...
            <input type="number"  id="column-own-8" class="form-control" placeholder="Code"
                name="bank_branch_code" value="{{ old('bank_branch_code') }}" />
...
<div class="col-md-6 col-12">
    <div class="mb-1">
        ...
        <input type="text"  id="column-own-9 iban" class="form-control" placeholder="IBAN#"
