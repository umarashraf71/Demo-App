    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Add New Department Record</h4>
        </div>
        <div class="card-body">
          ...
          <form class="form" action="{{ route('dept.store') }}" method="POST">
            ...
            <div class="row">
              <div class="col-md-6 col-12">
                <div class="mb-1">
                  <label class="form-label" for="dept-code-column">Department Code *</label>
                  <input
                    type="text"
                    id="dept-code-column"
                    class="form-control"
              ...
              <div class="col-md-6 col-12">
                <div class="mb-1">
                    <label class="form-label" for="select2-multiple">MCAS Plant Select *</label>
                    <select
                    ...
                    >
                        ...
                        <option
                        value="{{ $value->id }}"
                        {{ (Input::old("plant_id") == $value->id  ? "selected":"") }}
                        >{{ $value->name }}</option>
                        @endforeach
                    </select>
                    @error('plant_id')
