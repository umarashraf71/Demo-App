    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("dept.create")}}">Add New</a>
...
editData = "@php echo Auth::user()->can('Edit Department') @endphp";
deleteData = "@php echo Auth::user()->can('Delete Department') @endphp";
