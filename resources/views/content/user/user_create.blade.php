            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12">
                <div class="mb-1">
                  ...
                  <select id="role_dropdown" class="form-control" name="role_id" required>
                    <option disabled selected>Select Role</option>
                    @foreach ($roles as $role)
                    <option
                    value="{{$role->name}}" data-access="{{$role->access_level}}" data-single="{{$role->is_single}}"
                    {{ (Input::old("role_id") == $role->name ? "selected":"") }}
                    >{{$role->name}}</option>
                    @endforeach
                  </select>
                  @error('role_dropdown')
              ...
              <div class="col-md-6 col-12">
                <div class="mb-1">
                  ...
                  <select id="access_level_id" name="access_level_ids[]" multiple required></select>
              ...
              <div class="col-md-6 col-12">
                ...
                <div class="col-md-6 col-12">
                    <div class="mb-1">
                        ...
                        <input type="text" id="column-ao5" class="form-control" placeholder="Enter Jazz FFM Portal Tracking Number" name="tracking_no" value="{{ old('tracking_no') }}"  />
                        @error('tracking_no')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
              ...
              <div class="col-md-6 col-12">
                ...
                <div class="form-check form-check-inline mt-1">
                  <input class="form-check-input" type="checkbox" id="mobile_user_only" name="mobile_user_only" value="1">
