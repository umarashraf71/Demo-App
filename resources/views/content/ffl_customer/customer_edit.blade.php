                        ...
                        <form class="form" action="{{ route('customer.update', $customer->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="code-column">Customer Code <span
                                                class="text-danger">*</span></label>
                                        <input type="text" id="code-column" class="form-control" placeholder="Code"
                                            name="code" disabled value="{{ old('code', $customer->code) }}"
                                            maxlength="7" />
                                        @error('code')
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="name-column1" class="form-control" placeholder="c/o Name"
                                            name="c_o_name" value="{{ old('c_o_name', $customer->c_o_name) }}" />
                                        @error('c_o_name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="cnic"> CNIC# <span
                                                class="text-danger">*</span></label>
                                        <input type="text" maxlength="15" id="cnic" class="form-control cnic"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="ntn" class="form-control" placeholder="NTN"
                                            name="ntn" required value="{{ old('ntn', $customer->ntn) }}" />
                                        @error('ntn')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="gst" class="form-control" placeholder="Gst"
                                            name="gst" required value="{{ old('gst', $customer->gst) }}" />
                                        @error('gst')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="contact"> Contact# <span
                                                class="text-danger">*</span></label>
                                        <input type="text" required class="form-control phone" name="contact"
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="mb-1">
                                        <label class="form-label" for="address-column">Address <span
                                                class="text-danger">*</span></label>
