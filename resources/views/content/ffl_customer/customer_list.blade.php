...
@section('title', 'Customers Records')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        ...
                        @can('Create Customer')
                            <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{ route('customer.create') }}">Add
                                New</a>
                        @endcan
                    </div>
...
@section('page-script')
    ...
    <script>
        ...
        editData = "@php echo Auth::user()->can('Edit Customer') @endphp";
        deleteData = "@php echo Auth::user()->can('Delete Customer') @endphp";
