...
@section('title', 'AO Collection Summary')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">Area Office Collection Summary</h4>
                    </div>
                          ...
                          <div class="row" style="margin: 10px">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control"  name="export_to" id="export_to">
                                    ...
                                    <option class="form-control"  value="PDF">Pdf</option>
                                </select>
                                @error('export_to')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
        ...
        table = $('#collection_point_datatable').DataTable({
            ...
            ajax: {
                ...
                data: function(d) {
                    ...
                    d.area_office_id = $('#area_office_id').val();
                }
            },
            columns: [{
                data: 'serial_number',
