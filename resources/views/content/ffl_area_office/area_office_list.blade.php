    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">Area Offices</h4>
          @can('Create Area Office')
          <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("area-office.create")}}">Add New</a>
          @endcan
        </div>
        ...
        <div class="card-datatable table-responsive ">
          <table class="table" id="area_office_table">
            <thead>
              <tr>
                <th>No.</th>
                <th>Code</th>
...
editData = "@php echo Auth::user()->can('Edit Area Office') @endphp";
deleteData = "@php echo Auth::user()->can('Delete Area Office') @endphp";
...
$('#area_office_table').DataTable({
    processing: true,
    serverSide: true,
    ajax: "{{ route('area-office.index') }}",
    columns: [
