                    ...
                    <div class="card-datatable table-responsive">
                        <table class="table table-bordered table-striped">
                            <tbody>
                                <tr>
                                    <th>Serial Number</th>
                                    <td>MR-{{ $purchase->serial_number }}</td>
                                ...
                                <tr>
                                    <th>Gross Volume</th>
                                    <td>{{ $purchase->gross_volume }}</td>
                                    <th>TS Volume</th>
                                    <td>{{ $purchase->volume_ts }}</td>
                                </tr>
                                <tr>
                                    <th>User</th>
                                    @if ($purchase->type == 'plant_reception')
                                    <td>{{ $purchase->user->name }}</td>
                                    @else
                                    <td>{{ $purchase->mmt->name }}</td>
                                    @endif
                                </tr>
                                <tr>
                                    <th>Opening Balance</th>
                                    <td>{{ $purchase->opening_balance }}</td>
                                ...
                                @if ($purchase->type == 'ao_lab_reception')
                                    <tr>
                                        <th>Route Name</th>
                                        <td>
                                            {{ $purchase->route->name }}
                                    ...
                                    <tr>
                                        <th>Vehicle</th>
                                        <td>
                                            {{ $purchase->route->RouteVehicle->vehicle->vehicle_number }}
                                        </td>
                                    </tr>
                                @endif
...
@section('page-script')
    ...
    <script>
        var tests = '<?php echo json_encode($purchase->tests); ?>';
