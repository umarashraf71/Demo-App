                    ...
                    <div class="card-header border-bottom">
                        <h4 class="card-title">
                            @if ($purchase->type == 'purchase_at_mcc')
                                MCC Purchase Details
                            @elseif ($purchase->type == 'mmt_purchase')
                                MMT Purchase Details
                            @endif
                        </h4>
                    </div>
                    ...
                    <div class="card-datatable table-responsive">
                        <table class="table table-bordered table-striped">
                            <tbody>
                                <tr>
                                    <th>Serial Number</th>
                                    <td>MPR-{{ $purchase->serial_number }}</td>
                                ...
                                <tr>
                                    ...
                                    <th>TS Volume</th>
                                    <td>{{ $purchase->ts_volume }}</td>
                                </tr>
                                <tr>
                                    <th>Opening Balance</th>
                                    <td>{{ $purchase->opening_balance }}</td>
                                    <th>Supplier Type</th>
                                    <td>{{ $purchase->supplier ? $purchase->supplier->supplier_type->name : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Time</th>
