    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("plant.create")}}">Add New</a>
        ...
        <div class="card-datatable table-responsive">
          <table class="table" id="plant_table">
            <thead>
              <tr>
                <th>No.</th>
                <th>Plant Code</th>
...
editData = "@php echo Auth::user()->can('Edit Plant') @endphp";
deleteData = "@php echo Auth::user()->can('Delete Plant') @endphp";
