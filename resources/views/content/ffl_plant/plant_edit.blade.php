    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Edit Plant Record</h4>
        </div>
        <div class="card-body">
        ...
        @endif
          <form class="form" action="{{ route('plant.update',$plant->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
              ...
              <div class="col-md-6 col-12">
                ...
                <div class="col-md-12">
                    <div class="mb-1">
                        ...
                        <input id="address" name="address" class="form-control" type="text" value="{{old('address',$plant->address)}}" placeholder="Location">
                ...
                <div class="col-12">
                    <div id="map" class="home-map">
                        <div id="map-canvas" class="map-canvas-event" style="height: 260px; margin-bottom: 1%"></div>
                    </div>
                </div>
              <div class="col-12">
                <button type="submit" class="btn btn-primary me-1">Submit</button>
                <button type="reset" class="btn btn-outline-secondary me-1">Reset</button>
                <a class="btn btn-outline-secondary cancel-btn" href="{{ route('plant.index') }}" >Cancel</a>
              </div>
            </div>
          </form>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAfh-Jh-Vn1Lf2TeP9g9cf5bzRbX1gnFZ4&libraries=places&callback=initAutocomplete&libraries=places" async defer></script>
<script>
    // initAutocomplete();
