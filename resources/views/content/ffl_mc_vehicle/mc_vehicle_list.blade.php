...
@section('title', 'Milk Collection Vehicles')
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">Milk Collection Vehicles</h4>
          @can('Create MCVehicle')
             <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("mc-vehicle.create")}}">Add New</a>
          @endcan
        </div>
        ...
        <div class="card-datatable">
          <table class="table " id="mc_vehicle_datatable">
            <thead>
              <tr>
                <th>No.</th>
...
editData = "@php echo Auth::user()->can('Edit MCVehicle') @endphp";
deleteData = "@php echo Auth::user()->can('Delete MCVehicle') @endphp";
...
$('#mc_vehicle_datatable').DataTable({
    processing: true,
    serverSide: true,
    ajax: "{{ route('mc-vehicle.index') }}",
    columns: [
