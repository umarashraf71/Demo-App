    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("inventory-item.create")}}">Add New</a>
          @endcan
        </div>
        ...
        <div class="card-datatable table-responsive">
          <table class="table" id="inventory_item_datatable">
            <thead>
              <tr>
                <th>No.</th>
                <th>Item Code</th>
...
editData = "@php echo Auth::user()->can('Edit Inventory Item') @endphp";
deleteData = "@php echo Auth::user()->can('Delete Inventory Item') @endphp";
...
$('#inventory_item_datatable').DataTable({
    processing: true,
    serverSide: true,
    ajax: "{{ route('inventory-item.index') }}",
    columns: [
    ...
    {data: 'area_office_id', name: 'area_office_id'},
