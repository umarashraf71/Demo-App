            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header border-bottom">
                        <h4 class="card-title">Tehsils</h4>
                        @can('Create Tehsil')
                    ...
                    <div class="card-datatable">
                        ...
                        @endif
                        <table class="table" id="tehsil_table">
                            <thead>
                                <tr>
                                    <th>No.</th>
                                    <th>Short Name</th>
                ...
                <div class="modal-body px-sm-5 pb-5">
                    ...
                    <form class="form" id="createForm" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="district_name">District</label>
                                    <select class="form-control select2" name="district_id" required id="exampleSelect">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-sm-5 pb-5">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">Update Tehsil</h1>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <select class="form-control select2" name="district_id" required id="districtSelect">
                                    </select>
                                    <span class="text-danger edit_district"></span>
                                </div>
                            </div>
...
@section('page-script')
    ...
    <script>
        ...
        $('#tehsil_table').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('tehsils.index') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
        ...
        function editRecord(id, name, sn, dis) {
            $("#id").val(id);
            $("#edit_name").val(name);
        ...
        $(document).on('submit', '#editForm', function(e) {
            ...
            $.ajax({
                url: '{{ route('tehsil.update') }}',
                method: 'POST',
                data: data,
                success: function(response) {
                    if (response.success) {
                        $('#tehsil_table').DataTable().ajax.reload();
