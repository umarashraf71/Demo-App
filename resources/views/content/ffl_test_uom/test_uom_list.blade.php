    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">Test UOM List</h4>
          @can('Create Test UOM')
          <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("test-uom.create")}}">Add New</a>
          @endcan
        </div>
        ...
        <div class="card-datatable table-responsive">
          <table class="table" id="test_uom_datatable">
            <thead>
              <tr>
                <th>No.</th>
                <th>Name</th>
...
editData = "@php echo Auth::user()->can('Edit Test UOM') @endphp";
deleteData = "@php echo Auth::user()->can('Delete Test UOM') @endphp";
...
$('#test_uom_datatable').DataTable({
    processing: true,
    serverSide: true,
    ajax: "{{ route('test-uom.index') }}",
    columns: [
