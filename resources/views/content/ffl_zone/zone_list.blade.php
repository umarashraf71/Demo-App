    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header border-bottom">
          ...
          @can('Create Zone')
          <a class="add-new-btn btn btn-primary mt-2 mr_30px" href="{{route("zone.create")}}">Add New</a>
          @endcan
        </div>
...
editData = "@php echo Auth::user()->can('Edit Zone') @endphp";
deleteData = "@php echo Auth::user()->can('Delete Zone') @endphp";
