            ...
            <ul class="nav navbar-nav">
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        ...
                        <h2 class="brand-text mb-0">MCAS</h2>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="navbar-container d-flex content">
    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item d-none d-lg-block changeTheme" id="{{ $configData['theme'] === 'dark' ? 'light' : 'dark' }}"
            onclick="changeThememode(this)">
            <a class="nav-link nav-link-style"><i class="ficon"
                    data-feather="{{ $configData['theme'] === 'dark' ? 'sun' : 'moon' }}"></i></a>
        </li>

        @include('content._partials._sections.notifications_navbar')
        ...
        @if (Auth::User())
          ...
          <div class="dropdown-divider"></div> --}}
                {{-- @endif --}}
                <a class="dropdown-item" href="{{ route('change.password.view') }}">
                    <i class="me-50" data-feather="lock"></i> Reset Password
                </a>
                @if (Auth::check())
