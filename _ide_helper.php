...
')
     ...
     */ 
         ...
         * 
         *
         * @see \Pimlie\DataTables\MongodbDataTablesServiceProvider::boot()
         * @static 
         */ 
        public static function moloquent()
        {
                        return \Yajra\DataTables\DataTables::moloquent();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function mongodbQuery()
        {
                        return \Yajra\DataTables\DataTables::mongodbQuery();
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function mongodbHybrid()
        {
                        return \Yajra\DataTables\DataTables::mongodbHybrid();
        }
